...
<div class="container-fluid">
		...
		<input type="hidden" id="select_month" name="m" value="dashboardfwd">
		...
		$totalcongty += 1;
		  ...
		  <div class="card" >
              <div class="card-header border-0" style="background-color:#0066CC;color:white	" >
                <h3 class="card-title" >Thống kê doanh số FWD <?php echo $month;?></h3>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-striped table-valign-middle">
				  ...
				  $total_doanhthu = 0;
				  $total_loinhuan = 0;
				$laydulieulienketfwd = mysqli_query($conn,"select id,ten,hanmuc,payment_type,congty,cus_code from ns_user where roleid='2'");
while($laydulieulienketfwda = mysqli_fetch_array($laydulieulienketfwd))
{
		 $layidcus = mysqli_fetch_assoc(mysqli_query($conn,"select * from ns_customer where cus_code='".$laydulieulienketfwda['cus_code']."'"));

		$dulieuformonth =  fwdformonth($laydulieulienketfwda['id'],$new_month,$conn);
	echo'	<tr>
		<td><i class="fas fa-user-tie"></i> <a href="customer_detail.php?code='.$layidcus['id'].' "> '.$laydulieulienketfwda['congty'].' </a></td>
		...
		<td style="">'.congno(@$laydulieulienketfwda['payment_type']).' </td>
		<td style="color:red">'.number_format(@$dulieuformonth['chuathanhtoan']).' VNĐ</td>
