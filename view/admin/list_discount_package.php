<?php  
	...
	if (isset($_POST['btn_delete'])) {
		...
		$delete = $_POST['delete'];
		mysqli_query($conn,"DELETE FROM `ksn_discount_package` WHERE (`id`='$delete')");
	...
	if(isset($_POST['btn_add']))
	{
		...
		mysqli_query($conn,"INSERT INTO `ksn_discount_package` (`id_package`, `price_discount`, `uid`, `datetime`) VALUES ('".$_POST['id_package']."', '".$_POST['price_discount']."', '$uid', '$datenow')");	
...
<div class="container-fluid">DANH SÁCH USER SỬ DỤNG DISCOUNT<BR>
		...
		<div class="row">
				 ...
				 <table id="example3" class="table table-hover table-bordered table-striped" width=100% data-page-length='50'  style="font-size:14px" data-order='[[0, "desc"]]'>
		            <thead style="color:blue">
		               <tr style="background-color:blue;color:white">
		                  ...
		                  <th style="text-align: center;color:#white">Price Discount</th>
		            ...
		            <tbody>
		               ...
		               $data = mysqli_query($conn,"SELECT * FROM ksn_discount_package order by uid DESC");
			...
			<h3 class="card-title"><i class="fas fa-user-tag"></i> DISCOUNT cho ID Package</h3>
			</div>
			<div class="card-body">
			...
			<div class="form-group" >
					<label for="">Nhập số tiền Discount</label>
					<input type="text"  name="price_discount" value="" class="form-control" required placeholder="Nhập số tiền muốn giảm giá">
			</div>
