...
<div class="container-fluid">
   ...
   <div class="row">
         ...
         if ($roleid == 1 || $roleid == 2) {
            echo '
               <div class="col-xs-3 mb-3 mr-2">
                  <a href="create_shipment_kr.php" class="btn btn-primary ">
                     <i class="fas fa-plus"></i> Tạo shipment KOREA
                  </a>
               </div>
      ...
      <div class="col-md-12">
         <h3 style="text-align:center;">Shipment GPE<img src="iconkorea.png" width=60px height=40px style="  border: 1px solid black;"></h3>
         <table id="example2" class="table table-hover table-bordered table-striped" data-page-length='50'  data-order='[[0, "desc"]]'>
            ...
            <tbody>
               ...
               $data = mysql_query("SELECT * FROM gpe_shipment_kr ");
               $i = 0;
               ...
               {  
				  ...
				  $laytongsokien = mysql_query("select * from gpe_shipment_kr_details where awb='".$item['awb']."'");
                  ...
                  echo '<a href="scan_shipment_kr.php?id='.$item['awb'].'" type="button" class="btn btn-primary">Update</a>';
                  //echo'  <a href="edit_shipment.php?id='.$item['id'].'" type="button" class="btn btn-warning"><i class="far fa-edit"></i></a> ';
                    
                     
                     echo'
                     <a href="mani_kr.php?id='.$item['id'].'" type="button" class="btn btn-primary"><i class="fa fa-download"></i></a>
                     <a href="mani_kr2.php?id='.$item['id'].'" type="button" class="btn btn-danger"><i class="fa fa-download"></i></a>
                     <a href="viewbillinshipment_kr.php?id='.$item['id'].'" type="button" class="btn btn-info"><i class="far fa-eye"></i></a>
                  </td>
                  </tr>';
               }
               ?>
