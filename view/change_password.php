...
<div class="card-body">   <form action="" method="POST">
  ...
  title="Key cần ít nhất 10 ký tự, bao gồm chữ thường , chữ viết hoa và số Vd:MrTuanShiba123" required placeholder="Ít nhất 10 ký tự gồm chữ thường, chữ hoa và số">
