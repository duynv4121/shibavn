...
for($z=1;$z <= 2;$z++)
{
echo'<table border=0 cellpadding=0 cellspacing=0 width=842 style=\'border-collapse:
 ...
 <tr height=20 style=\'height:15.0pt\'>
  <td height=20 class=xl6910479 colspan=2 style=\'height:15.0pt\'>'.$dulieuuser['congty'].'</td>
  <td class=xl1510479></td>
  <td colspan=6 class=xl9410479>'.@$nguoinhan['company_name'].'</td>
 </tr>
 <tr height=20 style=\'height:15.0pt\'>
  <td height=20 class=xl6910479 style=\'height:15.0pt\'>'.@$nguoigui['name'].'</td>
  <td class=xl6710479>'.@$nguoigui['phone'].'</td>
  <td class=xl1510479></td>
  <td colspan=3 class=xl9310479>'.@$nguoinhan['name'].'</td>
  <td colspan=3 class=xl9210479>'.@$nguoinhan['phone'].'</td>
 </tr>
 <tr height=20 style=\'height:15.0pt\'>
  ...
  <td class=xl1510479></td>
  <td class=xl1510479></td>
  <td colspan=6 class=xl6610479>'.@$nguoinhan['address'].'</td>
 </tr>
 <tr height=20 style=\'height:15.0pt\'>
...
echo'</td>
 ...
 <tr height=24 style=\'mso-height-source:userset;height:18.0pt\'>
  ...
  height:48.0pt;width:303pt\'>Description of Good : '.$package['kg_tenhang'].'<br>';
	...
	while($dulieukien = mysqli_fetch_array($laykien))
	{
		...
		if($count == 1)
		{
			...
			$id_kien1 = $dulieukien['convert_weight'];
		}
		if($count == 2)
		{
			@$lenght_kien1 = $dulieukien['width'];
			...
			@$id_kien2 = $dulieukien['convert_weight'];
		}
		if($count == 3)
		{
			@$lenght_kien1 = $dulieukien['width'];
			...
			@$id_kien3 = $dulieukien['convert_weight'];
		}
	}
	echo'</td>
  ...
  <td class=xl6510479 style=\'border-left:none\'>Dim Weight</td>
 </tr>
 <tr height=20 style=\'height:15.0pt\'>
 ...
 <tr height=20 style=\'height:15.0pt\'>
  <td height=20 class=xl7110479 style=\'height:15.0pt;border-top:none\'>';if($count>= 1) {echo '1';}echo'</td>
  <td class=xl6510479 style=\'border-top:none;border-left:none\'>'.$weight_kien1.'</td>
  <td class=xl6310479 style=\'border-top:none;border-left:none;text-align:center\'>'.$lenght_kien1.'</td>
  <td class=xl6310479 style=\'border-top:none;border-left:none;text-align:center\'>'.$width_kien1.'</td>
  <td class=xl6310479 style=\'border-top:none;border-left:none;text-align:center\'>'.$height_kien1.'</td>
  <td class=xl6310479 style=\'border-top:none;border-left:none;text-align:center\'>'.$id_kien1.'</td>
 </tr>
 <tr height=20 style=\'height:15.0pt\'>
  ...
  <td class=xl7110479 style=\'border-top:none\'>';if($count>= 2) {echo '2';}echo'</td>
  <td class=xl6510479 style=\'border-top:none;border-left:none\'>'.@$weight_kien2.'</td>
  <td class=xl6310479 style=\'border-top:none;border-left:none;text-align:center\'>'.@$lenght_kien2.'</td>
  <td class=xl6310479 style=\'border-top:none;border-left:none;text-align:center\'>'.@$width_kien2.'</td>
  <td class=xl6310479 style=\'border-top:none;border-left:none;text-align:center\'>'.@$height_kien2.'</td>
  <td class=xl6310479 style=\'border-top:none;border-left:none;text-align:center\'>'.@$id_kien2.'</td>
 </tr>
 <tr height=20 style=\'height:15.0pt\'>
  <td height=20 class=xl7110479 style=\'height:15.0pt;border-top:none\'>';if($count>= 3) {echo '3';}echo'</td>
  <td class=xl6510479 style=\'border-top:none;border-left:none\'>'.@$weight_kien3.'</td>
    <td class=xl6310479 style=\'border-top:none;border-left:none;text-align:center\'>'.@$lenght_kien3.'</td>
  <td class=xl6310479 style=\'border-top:none;border-left:none;text-align:center\'>'.@$width_kien3.'</td>
  <td class=xl6310479 style=\'border-top:none;border-left:none;text-align:center\'>'.@$height_kien3.'</td>
  <td class=xl6310479 style=\'border-top:none;border-left:none;text-align:center\'>'.@$id_kien3.'</td>
 ...
 <tr height=20 style=\'height:15.0pt\'>
  ...
  height:15.0pt\'>Total Weight: '.$tongcannang.' KG</td>
 ...
 <tr height=20 style=\'height:15.0pt\'>
  ...
  height:45.0pt;border-top:none;width:150pt\'>QRCODE (Scan QR để Tracking)<br>
    <br>
    <span style=\'mso-spacerun:yes\'>    <center>  <div id="id_qrcode'.$z.'" style="margin-top:-50px"></div>
 </center> </span></td>
  <td rowspan=3 class=xl9910479 width=204 style=\'border-bottom:.5pt solid black;
  border-top:none;width:153pt\'>Pick up by:<br>
    <br><br><br><br><br><br>
    <span style=\'mso-spacerun:yes\'></span>Datetime:'.$datetime1.' </td>
...
\'>Pieces:  '.$count.' 
 ...
 <tr height=20 style=\'height:15.0pt\'>
  ...
  height:15.0pt\'>Service : <b>';echo dichvu($conn,$package['kg_dichvu']);echo'</b> </td>
  <td colspan=3 class=xl9510479 style=\'border-right:.5pt solid black;vertical-align: middle; font-size:15px
  border-left:none\'>Invoice Value : '.$package['kg_valueinvoice'].'</td>
 </tr>
 <tr height=20 style=\'height:15.0pt\'>
  <td colspan=3 height=20 class=xl9510479 style=\'border-right:.5pt solid black;vertical-align: middle; font-size:15px
...
echo'<script>
	...
	var qrcode = new QRCode("id_qrcode1", {
				text:"https://app.shibaexpress.vn/tracking/'.$package['id_code'].'",
				width:120,
				height:115,
				colorDark:"#000000",
				colorLight:"#ffffff",
