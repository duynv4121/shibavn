...
">
  ...
  <table cellpadding=0 cellspacing=0>
   ...
   <tr>
	...
	$quocgia_name = mysql_fetch_assoc(mysql_query("select * from ns_countries where id='$quocgia'"));
	if($quocgia == 208)
	{
 ...
 <tr height=44 style='mso-height-source:userset;height:33.0pt'>
  ...
  height:33.0pt;width:171pt'><?php echo $string1;?><br>
    <?php echo $string2;?></td>
    <td colspan=4 height=44 class=xl73 width=230 style='border-right:.5pt solid black;
  height:33.0pt;width:171pt'><?php echo $string3;?> <?php 
 ...
 <tr height=42 style='mso-height-source:userset;height:31.5pt'>
  ...
  height:31.5pt;width:171pt'><?php echo $string4;?><b><?php echo $data['cannang']; ?> kg</b><br>
    
<?php echo $string5;?></td>
  <td colspan=4 rowspan=2 class=xl82 style='border-right:.5pt solid black;
  border-bottom:.5pt solid black'><?php echo $string6;?>
 ...
 <tr height=44 style='mso-height-source:userset;height:33.0pt'>
  <td colspan=4 height=44 class=xl73 width=230 style='border-right:.5pt solid black;
  height:33.0pt;width:171pt'><?php echo $string7;?><br>
    <?php echo $string8;?></td>
 </tr>
 <tr height=19 style='height:14.4pt'>
  <td colspan=4 height=19 class=xl87 style='border-right:.5pt solid black;
  height:14.4pt'><?php echo $string9;?></td>
...
document.getElementById("datetime").innerHTML = dt.toLocaleString();
	...
	<input type=hidden id="abcId1" name="abcId1" 
                  value="<?php echo $data['code_kerry'].$data['code_tcat']; ?>"/>	
	
	
	<input type=hidden id="abcId2" name="abcId2" 
                  value="<?php echo $data['code_tcat']; ?>"/>
<script>
		function onReady()
		{
...
{
echo'
JsBarcode("#barcode2", document.getElementById(\'abcId1\').value, {
