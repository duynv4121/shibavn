...
<?php
	...
	$laydulieukienadd = mysql_query("select * from ns_listhoadon where id_package='".$id."'");
	while($laydulieukien = mysql_fetch_array($laydulieukienadd))
	{
    $data = mysql_fetch_assoc(mysql_query("SELECT * FROM ns_listhoadon WHERE id='".$laydulieukien['id']."'"));
...
echo'	</font></td>
 ...
 <tr height=44 style=\'mso-height-source:userset;height:33.0pt\'>
  ...
  height:33.0pt;width:171pt\'>Payment 지불 방법:<br>
    Receiver 수화기：</td>
    <td colspan=4 height=44 class=xl73 width=230 style=\'border-right:.5pt solid black;
  height:33.0pt;width:171pt\'>Content 콘텐츠： ';
 ...
 <tr height=42 style=\'mso-height-source:userset;height:31.5pt\'>
  ...
  height:31.5pt;width:171pt\'>Actual WT 실제 무게：<b>';
...
Pieces 선적 수량：</td>
 ...
 <tr height=19 style=\'height:14.4pt\'>
  ...
  height:14.4pt\'>Total Charge 화물:</td>
...
';
	...
	$laydulieukienadd = mysql_query("select * from ns_listhoadon where id_package='".$id."'");
		...
		{
	echo'
	var qrcode = new QRCode("id_qrcode'.$laydulieukien['id'].'", {
				text:"http://guihangquocte.online/view/trackingview.php?id="+document.getElementById(\'abcId'.$laydulieukien['id'].'\').value,
				width:120,
				height:115,
				colorDark:"#000000",
				colorLight:"#ffffff",
