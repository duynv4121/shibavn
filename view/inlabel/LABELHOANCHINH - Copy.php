...
?>
<title>LABEL KANGO <?php echo$package['id_code'];?></title>
...
<table border=0 cellpadding=0 cellspacing=0 width=404 style=\'border-collapse:
 ...
 <tr height=20 style=\'height:15.0pt\'>
  <td height=20 class=xl889758 colspan=5 style=\'height:15.0pt\'  style=\'white-space: pre-wrap;\'>'.$nguoigui['address'].', '.$ward['name'].', '.$district['name'].'<span style=\'mso-spacerun:yes\'> </span></td>
  <td class=xl689758>&nbsp;</td>
 </tr>
 <tr height=20 style=\'height:15.0pt\'>
 ...
 <tr height=20 style=\'height:15.0pt\'>
  <td colspan=3 height=20 class=xl889758 style=\'height:15.0pt\'>'.$nguoinhan['phone'].'</td>
  <td class=xl159758></td>
  <td class=xl159758></td>
  <td class=xl689758>&nbsp;</td>
 </tr>
 <tr height=20 style=\'height:15.0pt\'>
  <td height=20 class=xl889758 colspan=3 style=\'height:15.0pt\'>'.$nguoinhan['address'].'</td>
  <td class=xl159758></td>
  <td class=xl159758></td>
  <td class=xl689758>&nbsp;</td>
 </tr>
 <tr height=20 style=\'height:15.0pt\'>
  <td height=20 class=xl889758 colspan=2 style=\'height:15.0pt\'>'.$citynhan['name'].' '.$nguoinhan['state'].' '.$nguoinhan['post_code'].'</td>
  <td class=xl159758></td>
  <td class=xl159758></td>
  <td class=xl159758></td>
  <td class=xl689758>&nbsp;</td>
 ...
 <tr height=20 style=\'height:15.0pt\'>
  <td height=20 class=xl899758 style=\'height:15.0pt\'>&nbsp;</td>
...
';
	...
	echo'	var qrcode = new QRCode("id_qrcode'.$laydulieukienzz['id_code'].'", {
				text:"https://ksnpost.com/index1.php?id="+document.getElementById(\'abcId'.$laydulieukienzz['id_code'].'\').value,
				width:120,
				height:115,
				colorDark:"#000000",
				colorLight:"#ffffff",
