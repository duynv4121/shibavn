<?php  
    ...
    if (isset($_POST['btn_login'])) {
        ...
        if ($num_rows==0) {
			...
			if($layid['roleid'] == 1 || $laydulieucheck['status'] == 2)
			{
   ...
   : ($_SERVER['HTTP_X_FORWARDED_FOR'] 
        ...
        : $_SERVER['REMOTE_ADDR']);
				...
				GPE System<br>Automated message. Please do not reply.
				 ...
				 <tr>
                <td align='center' style='font-size:12px;color:#999;padding:20px 0'>© 2023 GPE.online All Rights Reserved<br>URL：<a style='color:#999;text-decoration:none' href='http://GPEexp.com' target='_blank' >www.GPEexp.com</a>&nbsp;&nbsp;E-mail：<a href='mailto:info@GPEexp.vn' style='color:#999;text-decoration:none' target='_blank'>info@GPEexp.vn</a></td>
				</tr>
...
<div class="signupform">
	<div class="container">
		...
		<div class="agile_info">
			...
			<div class="w3_info">
				<center><h2  style="font-family:Arial" style="color:blue"><img src="logo-export.png" width=150px height=70px></h2>
