...
<div class="container-fluid">
   ...
   <div class="row">
      ...
      <div class="col-md-12">
         <h3 style="text-align:center;">Danh sách kiện nhỏ trong lô (AIR) (<?php echo $getId; ?>)</h3>
         <table id="example2" class="table table-hover table-bordered table-striped" data-page-length='100'  >
            ...
            <tbody>
               ...
               $data = mysql_query("SELECT * FROM ns_listhoadon WHERE id_package = '$getId'");
               
               while($item = mysql_fetch_array($data))
               {  
                  $listcatalog = mysql_query("SELECT * FROM ns_mapcatalog WHERE id_bill = '".$item['id']."'");
                  $arr = [];
                  $str_type = "";
                  ...
                  echo '</td>
                  <td>
                     <a href="edit_sub_package_for_find.php?id='.$item['id'].'" type="button" class="btn btn-warning"><i class="far fa-edit"></i></a>
                  </td>';
               }
               ?>
