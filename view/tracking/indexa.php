...
echo'<script> 
				...
				if(isset($_GET['b']))
				{
					...
					window.location = "home.php";
						...
						$url = 'http://GPE.online/view/tracking/gettrack.php?billketnoi='.trim($laydulieuhoadon['billketnoi']).'&hangketnoi='.$laydulieuhoadon['hangketnoi'];
      ...
      <div class="frame-7150-Me9">
        <div class="value-K5B">
          <div class="auto-group-vgqf-S9o">
			...
			if(@$arr['data'][0]['origin_info']['trackinfo'][0]['Details'] != "")
			{
