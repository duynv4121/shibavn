<?php  
	...
	function exportMNF($id){
		...
		$result = mysql_query("SELECT * FROM gpe_shipment_philip_details WHERE awb = '$id' order by bag_code ASC")or die(mysql_error());
	...
	if (isset($_GET['id'])) {
		...
		$layidship = mysql_fetch_assoc(mysql_query("select * from gpe_shipment_philip where id='".$_GET['id']."'"));
