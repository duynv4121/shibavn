...
echo'<br><br>
			...
			?>
					...
					echo'</select>
										...
										<option value="HCM" '; if(@$_GET['brand'] == 'HCM'){echo'selected';} echo'>HCM</option>
			...
			<option value="tracking" '; if(@$_GET['s_type'] == 'tracking'){echo'selected';}echo'>Search by Tracking Code</option>
			';
			
			if($roleid != 2)
			{
			echo'<option value="company" '; if(@$_GET['s_type'] == 'company'){echo'selected';}echo'>Search by Sender Company </option>';
			
			}
			echo'<option value="receiver" '; if(@$_GET['s_type'] == 'receiver'){echo'selected';}echo'>Search by Receiver name</option>';
			echo'<option value="address" '; if(@$_GET['s_type'] == 'address'){echo'selected';}echo'>Search by Receiver Address</option>';
			echo'
			</select></div></div>
