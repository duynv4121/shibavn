...
while($row  = mysqli_fetch_array($result,MYSQLI_ASSOC))
{
	...
	if($dulieukhachhang['payment_price_type_c'] != '' AND $result2a['date'] >= $dulieukhachhang['payment_price_type_date'])
	{
	...
	else
	{
		...
		else if($result2a['kg_dichvu'] == 13 || $result2a['kg_dichvu'] == 34 || $result2a['kg_dichvu'] == 14 || $result2a['kg_dichvu'] == 7|| $result2a['kg_dichvu'] == 9|| $result2a['kg_dichvu'] == 10 || $result2a['kg_dichvu'] == 11 || $result2a['kg_dichvu'] == 28 || $result2a['kg_dichvu'] == 30 || $result2a['kg_dichvu'] == 31|| $result2a['kg_dichvu'] == 32|| $result2a['kg_dichvu'] == 33)
		{
