		...
		$cannang_tp = $_POST['cannang_tp'];
	   	if ($cannang_thuong + $cannang_mp + $cannang_tp <= 0) {
			...
			';
	   		...
	   		mysql_query("UPDATE `ns_package` SET `cannang_thuong`='$cannang_thuong', `cannang_mp`='$cannang_mp', `cannang_tp`='$cannang_tp' WHERE id = '$id'") or die(mysql_error());
	   		echo '
				<script>
					window.location = "create_sub_package.php?id='.$id.'";
				</script>
			';
	   	}
	}
...
<div class="container-fluid">
	<form action="" method="POST">
		<div class="row">
			...
			<div class="col-md-6">
				<h5>Nhập cân nặng từng loại hàng (AIR)</h5>
				<hr>
				<table>
					<tr>
						<td width="100%">
