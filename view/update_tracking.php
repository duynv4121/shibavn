...
$text = nl2br($text); // insert <br /> before \n 
	...
	mysqli_query($conn,"INSERT INTO `ksn_giadichvu` (`id_dichvu`, `m_price`, `price`,`m_price_string`,`note`) VALUES ('4', '$mabill','$macj','$string','GPE-MY')")or die(mysqli_error());
	mysqli_query($conn,"INSERT INTO `ksn_giadichvu2` (`id_dichvu`, `m_price`, `price`,`m_price_string`,`note`) VALUES ('4', '$mabill','$macj','$string','GPE-MY')")or die(mysqli_error());
	mysqli_query($conn,"INSERT INTO `ksn_giadichvu3` (`id_dichvu`, `m_price`, `price`,`m_price_string`,`note`) VALUES ('4', '$mabill','$macj','$string','GPE-MY')")or die(mysqli_error());
