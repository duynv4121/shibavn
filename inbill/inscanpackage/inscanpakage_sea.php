...
<table border=0 cellpadding=0 cellspacing=0 width=563 style='border-collapse:
 ...
 <tr style="margin-left:1rem" height=112 style='mso-height-source:userset;height:84.0pt'>
...
<p style="font-family: Calibri;font-size:13px">Time: <span id="datetime"></span> - NEWSKY EXPRESS</p> 
