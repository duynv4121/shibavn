...
if($hoadonadd['checkinbill'] >= 1)
{
	echo'<script>

		  alert("Bạn đã in bill này lần thứ '.($hoadonadd['checkinbill']+1).'");

		</script>';
}
mysql_query("UPDATE `gpe_listhoadonus` SET `checkinbill`=(`checkinbill`+1) WHERE (`id`='$idbill')");
?>
...
<table border=0 cellpadding=0 cellspacing=0 width=474 style='border-collapse:
 ...
 <tr height=19 style='height:14.4pt'>
  ...
  height:86px'><img width=150 height=100 src=<?php echo $dulieuuser['logo'];?> v:shapes="Picture_x0020_2"></span><![endif]><span
 ...
 <tr height=19 style='height:14.4pt'>
  ...
  <td class=xl65></td>
  <td class=xl65></td>
  <td class=xl65 colspan=3 style='mso-ignore:colspan'>Tel:  <?php echo $dulieuuser['sdt'];?></td>
  <td class=xl65></td>
 </tr>
 <tr height=19 style='height:14.4pt'>
  <td height=19 class=xl65 style='height:14.4pt'></td>
 ...
 <tr height=130 style='mso-height-source:userset;height:97.5pt'>
  ...
  <table cellpadding=0 cellspacing=0>
   <tr>
	...
	if($hoadonadd['checkinbill'] >= 1)
{
	echo'  <div class="centered">Copies: <b>'.($hoadonadd['checkinbill']+1).'</b></div>
';
}
 ...
 <tr height=42 style='mso-height-source:userset;height:31.5pt'>
  ...
  height:31.5pt;width:171pt'>Actual WT ：<b><?php echo $hoadonadd['cannang']; ?> lbs</b><br>
...
<script>
		function onReady()
		{
			var qrcode = new QRCode("id_qrcode", {
				text:"http://ad2.saomaiservices.com/scanbarcodevn3.php?id="+document.getElementById('abcId').value,
				width:111,
				height:111,
				colorDark:"#000000",
				colorLight:"#ffffff",
