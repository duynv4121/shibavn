...
$idbilladd = 'SMVN'.$idbill;
$hoadonadd = mysql_fetch_assoc(mysql_query("select * from gpe_listhoadonus_vn where id='$idbill'"));
$nguoiguiadd = mysql_fetch_assoc(mysql_query("select * from gpe_nguoiguius_vn where id_hoadon='$idbill'"));
$nguoinhanadd = mysql_fetch_assoc(mysql_query("select * from gpe_nguoinhanus_vn where id_hoadon='$idbill'"));

				$id_user = $hoadonadd['id_user'];
...
<table border=0 cellpadding=0 cellspacing=0 width=474 style='border-collapse:
 ...
 <tr height=19 style='height:14.4pt'>
  ...
  height:86px'><img width=150 height=100 src=60.jpg v:shapes="Picture_x0020_2"></span><![endif]><span
 ...
 <tr height=21 style='height:15.6pt'>
  ...
  <td class=xl65></td>
  <td class=xl65></td>
  <td class=xl97 colspan=3 style='mso-ignore:colspan'><?php echo $dulieuuser['congty'];?></td>
  <td class=xl65></td>
 </tr>
  ...
  <?php echo $dulieuuser['website'];?></td>
 </tr>
 <tr height=19 style='height:14.4pt'>
  <td height=19 class=xl65 style='height:14.4pt'></td>
  <td class=xl65></td>
  <td class=xl65></td>
  <td class=xl65></td>
  <td class=xl65 colspan=3 style='mso-ignore:colspan'>Tel: (84)798139996 | (84)392717468</td>
  <td class=xl65></td>
 </tr>
 <tr height=19 style='height:14.4pt'>
  <td height=19 class=xl65 style='height:14.4pt'></td>
  ...
  <td class=xl65></td>
  <td class=xl65></td>
  <td class=xl65 colspan=3 style='mso-ignore:colspan'>Email: <?php echo $dulieuuser['mst'];?></td>
 ...
 <tr height=90 style='mso-height-source:userset;height:67.5pt'>
  ...
  <table cellpadding=0 cellspacing=0>
   <tr>
    ...
    height:67.5pt;width:399pt'>Child AWB : <?php echo $idbilladd?> <br>
        <font class="font7">Main AWB: <?php echo $idbilladd?> </font></td>
   </tr>
  </table>
  </span></td>
 </tr>
 <tr height=130 style='mso-height-source:userset;height:97.5pt'>
  ...
  <table cellpadding=0 cellspacing=0>
   <tr>
    ...
    width:269pt'><?php echo '<font size=5px>AWB-'.$idbilladd.' '; 
	
	
	echo'</font>'?><font class="font6" style="font-size:27px"><br>
        <b>To:</b><br>
        <?php 
		echo ' <b>'.@$nguoinhanadd['n_congty'].'</b><br>';
		echo '* <b>'.@$nguoinhanadd['n_tennguoinhan'].'</b> <br>* SĐT: <b>'.$nguoinhanadd['n_dienthoai'].'</b>';
		echo'<br>
        * '.mb_strtoupper($nguoinhanadd['n_diachi1'], 'UTF-8').'</font>';
 ...
 <tr height=42 style='mso-height-source:userset;height:31.5pt'>
  ...
  height:31.5pt;width:171pt'>Actual WT ：<b><?php echo $hoadonadd['cannang']; ?> kg</b><br>
    
Pieces ：<b><?php echo $hoadonadd['sokien']; ?> pcs</b></td>
  <td colspan=4 rowspan=2 class=xl82 style='border-right:.5pt solid black;
  border-bottom:.5pt solid black;text-align:center'><svg id="barcode1"></svg>
</td>
 </tr>
 <tr height=44 style='mso-height-source:userset;height:33.0pt'>
  <td colspan=4 height=44 class=xl73 width=230 style='border-right:.5pt solid black;
 ...
 <tr height=19 style='height:14.4pt'>
  ...
  border-bottom:.5pt solid black;height:21.9pt;'>Remark: <?php echo $hoadonadd['loaihang']; ?><span
...
<p style="margin-left:40px;font-family: Calibri;font-size:13px">Date Printing: <span id="datetime"></span> - SAO MAI SERVICES</p> 
