...
<![endif]-->
   ...
   <body link=blue vlink=purple>
    ...
    $package = mysql_fetch_assoc(mysql_query("SELECT * FROM ns_package_sea WHERE id='".$data['id_package']."'"));
    ...
    $count =mysql_num_rows(mysql_query("SELECT * FROM ns_listhoadon_sea WHERE id_package = '".$package['id']."'"));
    // echo $count;
    ...
    width:205pt'><?php echo $dulieuuser['congty'];?><br>
    Website: <?php echo $dulieuuser['website'];?><br>
    Tel: <?php echo $dulieuuser['phone'];?><br>
    Email : <?php echo $dulieuuser['email'];?>
</td>
</tr>
...
<tr height=42 style='mso-height-source:userset;height:31.5pt'>
  <td height=42 class=xl65 style='height:31.5pt;border-top:none'><span
      ...
      text-decoration-style: initial;text-decoration-color: initial'>ORIGIN</span></td>
  </tr>
  <tr height=95 style='mso-height-source:userset;height:71.25pt'>
      <td height=95 class=xl74 style='height:71.25pt'><?php echo $countries['name']; ?></td>
  ...
  <tr height=26 style='mso-height-source:userset;height:20.1pt'>
      ...
      <tr height=26 style='mso-height-source:userset;height:20.1pt'>
          ...
          height:20.1pt'>Description:<font class="font15"> </font><font class="font14">
              <?php 
              $listcatalog = mysql_query("SELECT * FROM ns_mapcatalog_sea WHERE id_bill = '".$data['id']."'");
              $arr = [];
